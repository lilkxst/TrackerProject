...
final class CreateHabbitViewController: UIViewController {
    ...
    private func setupViews() {
        ...
        NSLayoutConstraint.activate([
            ...
            buttonsTableView.heightAnchor.constraint(equalToConstant: CGFloat(75 * buttons.count)),
    ...
    func activateCreateButton() {
        if category != nil, !choosenSchedule.isEmpty, choosenSchedule != [], indexOfSelectedColor != nil, indexOfSelectedEmoji != nil {
...
extension CreateHabbitViewController: CreateCategoryViewControllerDelegate {
...
extension CreateHabbitViewController: ScheduleViewControllerDelegate {
